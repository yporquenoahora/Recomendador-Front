...
<script>
    ...
    import { selectedTags, selectedSortOption, searchTerm, minScore, 
        filteredMovies, recomendadas, recomendadasTags} from '../stores/movieStore';
    ...
    import SvelteSlider from './Sv-Slider.svelte';
  ...
  <main>
   ...
   <!--  <p>Tags</p>
    ...
    <p>Tags relacionados, puedes seleccionar algunos</p>
    <Bubbles data={sortedData} key={"keywords"}/>
    <p>Algunos temas, también los puedes filtrar</p>
